          ...
          <tbody>
            @foreach ($semester as $index => $kls)
              <tr>
                ...
                <td>{{ $kls->tanggal_mulai }}</td>
                <td>{{ $kls->tanggal_selesai }}</td>
                <td>
                    @if ($kls->status == 'AKTIF')
  ...
  <div class="modal-dialog">
    <form class="modal-content" id="editForm" action="" method="POST">
      ...
      <div class="modal-body">
        ...
        <div class="mb-3">
          <label for="edit-tanggal_mulai" class="form-label">Tanggal Mulai</label>
          <input type="date" class="form-control" id="edit-tanggal_mulai" name="tanggal_mulai"></textarea>
        </div>
        <div class="mb-3">
          <label for="edit-tanggal_selesai" class="form-label">Tanggal Selesai</label>
