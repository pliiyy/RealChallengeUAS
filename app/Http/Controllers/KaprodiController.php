...
class KaprodiController extends Controller
{
    ...
    {
        $query = Kaprodi::with(['user.biodata', 'prodi']);
        ...
        $users = User::whereDoesntHave('role', function ($query) {
            $query->where('nama', 'kaprodi');
        })->get();
        return view('kaprodi', compact('kaprodi','fakultas','users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $roleDekan = Role::where('nama','kaprodi')->first();
        ...
        return redirect('/kaprodi')->with('success', 'Data berhasil ditambahkan!');
    }
    ...
    public function destroy( $id)
    {
        ...
        return redirect('/kaprodi')->with('success', 'Kaprodi ' . $dekan->nama . ' berhasil dihapus!');
    }
}
